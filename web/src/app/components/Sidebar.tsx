...
const NAV = [
  {
    section: "Overview",
    items: [{ id: "overview" as PageId, icon: IconGrid, label: "Dashboard" }],
  },
  {
    section: "Market Data",
    items: [
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-line flex-shrink-0">
          ...
          <div className="relative flex-shrink-0">
            <div className="w-9 h-9 rounded-lg bg-acid flex items-center justify-center shadow-acid">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                  d="M8 1.5L14.5 5.25V12.75L8 16.5L1.5 12.75V5.25L8 1.5Z"
                  fill="#030303"
                />
          ...
          <div className="min-w-0">
            <div className="text-[14px] font-bold text-hi leading-snug tracking-tight">
              AI Engineer
            </div>
            <div className="text-[14px] font-bold text-hi leading-snug tracking-tight">
              Roadmap
...
function IconDollar() {
  return (
    ...
    >
      ...
      <path d="M10 3.5c-1.5-1.5-5.5-1-5.5 2s4 2.5 5.5 4 1.5 5.5-5.5 5.5" />
    </svg>
  );
}
function IconTrend() {
  return (
    ...
    >
      <polyline points="1,11 4.5,7 7.5,9 11,4" />
      <polyline points="9,4 11,4 11,6" />
    </svg>
  );
}
function IconList() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor">
      <rect x="1" y="2.5" width="12" height="1.5" rx=".75" />
      <rect x="1" y="6" width="12" height="1.5" rx=".75" />
      <rect x="1" y="9.5" width="8" height="1.5" rx=".75" />
    </svg>
  );
}
function IconGraph() {
...
function IconSource() {
  return (
    <svg
      ...
      strokeWidth="1.2"
    >
      <path d="M7 1l6 3.5v5L7 13 1 9.5v-5L7 1z" />
      <path d="M7 7l6-2.5M7 7L1 4.5M7 7v6" />
    </svg>
  );
}
