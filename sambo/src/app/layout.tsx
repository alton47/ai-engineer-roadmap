...
export const metadata: Metadata = {
  ...
  description: "Data-driven intelligence on the AI engineering job market. Real skills, real salaries, real postings.",
  keywords: ["AI engineering","LLM","RAG","salary data","machine learning jobs","roadmap"],
  openGraph: {
